...
5. Add session proxy, assistant page/navigation/context entry, evidence and history UX.
6. Verify using deterministic provider, real local database fixtures, provider transport
   fakes, migration checks, and dashboard lint/typecheck/tests/build. Document rollout.

Preserve existing untracked files and the current feature branch. Never provision or
use a live provider credential implicitly; automated work does not require one.
