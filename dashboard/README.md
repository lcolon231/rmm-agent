...
provides a responsive, accessible operations overview with fixture data and a
server-mediated operator sign-in boundary.
...
- No dashboard mutation, browser token, or persisted dashboard state exists
  yet. The signed-in overview remains fixture-backed. Dashboard audit records
  and database migrations are therefore not applicable to this foundation.
