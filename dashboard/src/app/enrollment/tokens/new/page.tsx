...
export default async function CreateEnrollmentTokenPage() {
  ...
  return (
    <>
      ...
      {sites.length === 0 ? <section className="enrollment-empty"><h2>A site is required</h2><p>Create a client and site in NodeLink before issuing an enrollment token.</p></section> : <CreateTokenForm sites={sites} />}
    </>
  );
}
