...
class Settings(BaseSettings):
    ...
    # Endpoint support chat. The browser origin is required before enabling it.
    support_chat_base_url: str | None = None
    support_chat_max_message_bytes: int = Field(default=4096, ge=1, le=4096)
