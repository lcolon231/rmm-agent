...
PRODUCER_DETAILS = {
    ...
    # Signed, staged agent self-update (issue #63). Operator prose (the halt and
    # rollback reasons) carries the sentinel and must survive only as a digest;
    # everything else is a bounded, non-secret build or policy identifier.
    "agent_update.release_published": {
        "release_id": ID1,
        "version": "0.2.0",
        "channel": "stable",
    ...
    "agent_update.rollout_paused": {"release_id": ID1, "rollout_percent": 10},
    "agent_update.rollout_resumed": {"release_id": ID1, "rollout_percent": 10},
    "agent_update.rollout_halted": {
        "release_id": ID1,
        "version": "0.2.0",
        "channel": "stable",
    ...
    "agent_update.halt_reason_recorded": {"release_id": ID1, "reason": SENTINEL},
    "agent_update.rollback_dispatched": {
        "reason": SENTINEL,
        "expected_current_version": "0.2.0",
        "current_version": "0.2.0",
    },
    "agent_update.outcome_reported": {
        "release_id": ID1,
        "command_id": ID3,
        "status": "rolled_back",
    ...
    # Approval workflows and two-person authorization (issue #64). Names and
    # justifications carry the sentinel: both are operator prose and must leave
    # only a digest behind.
    ...
    "approval_policy.updated": {
        ...
        "scope": "client",
        "scope_id": ID2,
        "previous_command_kinds": ["powershell"],
        "command_kinds": ["powershell", "shell"],
        "previous_required_approvals": 2,
        "required_approvals": 2,
        "previous_request_ttl_seconds": 3600,
    ...
    "approval_request.decision_denied": {
        "approval_request_id": ID1,
        "kind": "powershell",
        "agent_id": ID2,
        "client_id": ID3,
        ...
        "status": "pending",
        "decision": "approve",
        "reason": "approval_self_not_permitted",
    },
    ...
    "approval_gate.allowed": {
        ...
        "policy_id": ID1,
        "required_approvals": 2,
        "approval_request_id": ID3,
        "reason": "approval_satisfied",
        "payload_sha256": "c" * 64,
        "approver_operator_ids": [ID1, ID2],
    },
    "approval_gate.denied": {
        "kind": "powershell",
        "agent_id": ID2,
        "policy_id": ID1,
        "required_approvals": 2,
    ...
    "mfa.credential_renamed": {
        "operator_id": ID1,
        "credential_id": ID2,
        "previous_name": SENTINEL,
        "new_name": SENTINEL,
    },
    ...
    "mfa.step_up_succeeded": {"operator_id": ID1, "credential_id": ID2},
